...
contract Multiart is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor(address _marketplaceAddress,address _adminAddress,address _mintPriceReceiver, address _transferFeeReceiver,address _tokenAddress,uint256 _royalty)
        ERC721("Multiart", "MAT")
    {
